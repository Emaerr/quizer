...
namespace Quizer.Services.Lobbies.impl.Tests
{
    ...
    public class LobbyControlServiceTests
    {
        ...
        {
            ILobbyControlService service = new LobbyControlService(LobbyMocks.GetScopeFactoryMock(LobbyMocks.GetLobbyRepositoryMock(isLobbyStarted: false)), new TestTimeService(), LobbyMocks.GetLoggerMock<LobbyControlService>());
