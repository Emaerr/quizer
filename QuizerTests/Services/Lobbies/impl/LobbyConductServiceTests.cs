...
namespace Quizer.Services.Lobbies.impl.Tests
{
    ...
    public class LobbyConductServiceTests
    {
        ...
        {
            ILobbyConductService service = new LobbyConductService(LobbyMocks.GetScopeFactoryMock(LobbyMocks.GetLobbyRepositoryMock()), new TestTimeService(), LobbyMocks.GetLoggerMock());
        ...
        public async Task RegisterTestAnswerTestAsync()
        {
            ...
            service = new LobbyConductService(LobbyMocks.GetScopeFactoryMock(LobbyMocks.GetLobbyWithUserRepositoryMock()), new TestTimeService(), LobbyMocks.GetLoggerMock());
            ...
            // should be success
            service = new LobbyConductService(LobbyMocks.GetScopeFactoryMock(LobbyMocks.GetLobbyStartedWithUserRepositoryMock()), new TestTimeService(), LobbyMocks.GetLoggerMock());
            result = await service.RegisterTestAnswer("0", "0", "0");
            Assert.IsTrue(result.IsSuccess);
        }
    }
